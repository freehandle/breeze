...
func (f *ActivityCommand) Execute(safe *Safe) error {
...
func (f *FirewallCommand) Execute(safe *Safe) error {
...
func (c *SyncCommand) Execute(safe *Safe) error {
...
func (s StatusCommand) Execute(safe *Safe) error {
...
func (c *ShowCommand) Execute(vault *Safe) error {
...
func dialAdmin(safe *Safe, nodeID string) (*admin.AdminClient, error) {
